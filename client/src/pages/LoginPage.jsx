      ...
      <div className="relative z-10 w-full max-w-md space-y-6 animate-slide-up">
        ...
        <div className="glass-card-static p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button disabled className="btn-ghost flex items-center justify-center gap-2 py-3 text-sm opacity-50 cursor-not-allowed relative">
              ...
              Google
              <span className="absolute -top-1 -right-1 text-[8px] font-bold text-neon-blue bg-neon-blue/15 px-1.5 py-0.5 rounded-full">Soon</span>
            </button>
            <button disabled className="btn-ghost flex items-center justify-center gap-2 py-3 text-sm opacity-50 cursor-not-allowed relative">
